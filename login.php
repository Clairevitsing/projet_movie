          ...
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  ...
                  <h4 class="mt-1 mb-5 pb-1">Never judge the book by its movie.</h4>
                </div>
				...
				<form method="post" action="login_process.php">
                  ...
                  <div class="form-outline mb-4">
                    <input type="password" id="form2Example22"  name="pwd"  class="form-control" placeholder="Password" required />
            ...
            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
              <div class="text-dark px-3 py-4 p-md-5 mx-md-4">
                <h4 class="mb-4">Welcome to the multilingual movie site</h4>
