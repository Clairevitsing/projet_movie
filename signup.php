              ...
              <h2 class="text-uppercase text-center mb-5">Create an account</h2>
                ...
                <!-- //hidden pour cacher le form -->
                      ...
                      <!-- <div class="form-outline mb-4">
                        ...
                        <input type="password" id="form3Example4cdg" class="form-control form-control-lg"  name="pwd" placeholder="Repeat Password" required />
                        
                      </div> -->

                      <?php var_dump($_FILES, $_POST);?>

                        <div class="form-outline mb-4">
                          <label class="form-label">Profile Pictures. Max file size 50 MB </label>
                          <input class="form-control form-control-lg" id="formFileLg" type="file" name="user_photo" />
